...
export default function Navbar() {
  ...
  return (
    <div className='flex justify-between items-center py-5 mx-8 sm:mx-20 xl:mx-32 cursor-pointer'>
        ...
        <div className='w- text-center rounded-lg  cursor-pointer flex  items-center '>
          <h1 onClick={()=> navigate('/')} className='text-2xl  uppercase font-bold text-gray-700 w-50'>BlogSphere</h1>
        </div>
